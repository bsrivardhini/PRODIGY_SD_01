...
public class Temp{
    public static void main(String[]args){
        ...
        System.out.println("Temperature Conersion Program");
        ...
        if(originalUnit.equals("celsius")) {
            ...
            System.out.println("Invalid unit of measurement. Please enter Celisus, Fahrenheit, or Kelvin.");
            System.exit(1);
        }  
